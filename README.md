...
'ID-1-Code-of-Conduct'. This preserves the privacy of Events Light and its employees and provides room for company deligates to add the right content. In the appendix of the design document there is a table that describes each ID code. For example in this case there would be an explanation of 'Attach the code of conduct document'.
